                  ...
                  <tr key={`skeleton-${i}`} style={{ borderBottom: '1px solid var(--border)' }}>
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        <div className="shimmer shimmer-block" style={{ width: '36px', height: '36px', borderRadius: '0.5rem', flexShrink: 0 }}></div>
                        <div className="shimmer shimmer-text" style={{ width: '100px', margin: 0 }}></div>
                      </div>
                    </td>
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <div className="shimmer shimmer-block" style={{ width: '40px', height: '22px', borderRadius: '999px' }}></div>
                        <div className="shimmer shimmer-block" style={{ width: '50px', height: '22px', borderRadius: '999px' }}></div>
                        <div className="shimmer shimmer-block" style={{ width: '30px', height: '22px', borderRadius: '999px' }}></div>
                      </div>
                    </td>
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <div className="shimmer shimmer-block" style={{ width: '18px', height: '18px', borderRadius: '4px' }}></div>
                        <div className="shimmer shimmer-text short" style={{ width: '60px', margin: 0 }}></div>
                      </div>
                    </td>
                    <td style={{ padding: '1.25rem 1.5rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <div className="shimmer shimmer-block" style={{ width: '18px', height: '18px', borderRadius: '4px' }}></div>
                        <div className="shimmer shimmer-text short" style={{ width: '40px', margin: 0 }}></div>
                      </div>
                    </td>
