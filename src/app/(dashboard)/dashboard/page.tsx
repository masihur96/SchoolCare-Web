  ...
  return (
    <div className="db-page">
      ...
      <div className="db-header animate-fade-in">
        <div style={{ flex: 1 }}>
          <div className="shimmer shimmer-text" style={{ width: '250px', height: '32px', marginBottom: '0.35rem' }}></div>
          <div className="shimmer shimmer-text" style={{ width: '150px', height: '14px', margin: 0 }}></div>
        </div>
        <div className="shimmer shimmer-block" style={{ width: '100px', height: '32px', borderRadius: '999px' }}></div>
      </div>

      {/* ── Marquee Banner ── */}
      <div className="db-marquee-banner shimmer animate-fade-in" style={{ height: '44px', border: 'none', animationDelay: '50ms' }}></div>

      {/* ── Stat Cards ── */}
      <div className="db-stats-grid">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="db-stat-card glass-card animate-fade-in" style={{ animationDelay: `${i * 80}ms` }}>
            <div className="shimmer shimmer-block" style={{ width: '52px', height: '52px', borderRadius: '0.9rem', flexShrink: 0 }}></div>
            <div className="db-stat-body" style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
              <div className="shimmer shimmer-text" style={{ width: '60px', height: '12px', margin: 0 }}></div>
              <div className="shimmer shimmer-text" style={{ width: '40px', height: '26px', margin: 0 }}></div>
              <div className="shimmer shimmer-text" style={{ width: '100px', height: '10px', margin: 0 }}></div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="db-section-header animate-fade-in" style={{ animationDelay: '400ms' }}>
        <div className="shimmer shimmer-text" style={{ width: '200px', height: '24px', margin: 0 }}></div>
      </div>
      <div className="db-att-grid animate-fade-in" style={{ animationDelay: '450ms' }}>
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="db-att-ring-card glass-card">
            ...
            <div className="db-att-ring-info" style={{ flex: 1 }}>
              <div className="shimmer shimmer-text" style={{ width: '120px', height: '16px', marginBottom: '0.5rem' }}></div>
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <div className="shimmer shimmer-block" style={{ height: '24px', width: '60px', borderRadius: '12px' }}></div>
                <div className="shimmer shimmer-block" style={{ height: '24px', width: '60px', borderRadius: '12px' }}></div>
              </div>
            </div>
          </div>
        ...
        <div className="db-att-breakdown glass-card">
          <div className="shimmer shimmer-text" style={{ width: '150px', height: '16px', marginBottom: '1.5rem' }}></div>
          {Array.from({ length: 4 }).map((_, i) => (
             <div key={i} className="db-bar-row" style={{ marginBottom: '0.75rem' }}>
               <div className="shimmer shimmer-text" style={{ width: '60px', height: '12px', margin: 0 }}></div>
               <div className="db-bar-track">
                  <div className="shimmer shimmer-block" style={{ height: '100%', width: '100%', borderRadius: '4px' }}></div>
               </div>
               <div className="shimmer shimmer-text" style={{ width: '30px', height: '12px', margin: 0 }}></div>
             </div>
          ))}
        </div>
      </div>
      ...
      <div className="db-bottom-grid">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="db-widget glass-card animate-fade-in" style={{ animationDelay: `${500 + i*50}ms` }}>
            <div className="db-widget-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div className="shimmer shimmer-text" style={{ width: '150px', height: '18px', margin: 0 }}></div>
              <div className="shimmer shimmer-text" style={{ width: '50px', height: '12px', margin: 0 }}></div>
            </div>
            <div className="db-widget-body" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', padding: '1.5rem' }}>
              {Array.from({ length: 3 }).map((_, j) => (
                <div key={j} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                  ...
                  <div style={{ flex: 1 }}>
                     <div className="shimmer shimmer-text" style={{ width: '80%', height: '14px', marginBottom: '6px' }}></div>
                     <div className="shimmer shimmer-text" style={{ width: '40%', height: '12px', margin: 0 }}></div>
                  </div>
                </div>
              ))}
            </div>
